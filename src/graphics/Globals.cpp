...
// calculate frame in transversal area
    ...
    std::cout << "Extrusion Height = " << _extrusionHeight << std::endl;
    std::cout << "Length to clear = " << _lengthToClear << std::endl;
}
